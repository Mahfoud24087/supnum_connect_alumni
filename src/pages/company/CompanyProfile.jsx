        ...
        >
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-8">
                        ...
                        <div className="flex-1 text-center md:text-left space-y-2">
                            ...
                            <p className="text-slate-500 dark:text-slate-400 flex items-center justify-center md:justify-start gap-2 text-lg">
                                <Building className="h-5 w-5 text-primary-500" /> {formData.industry || "Secteur d'activité"}
                            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <Card className="border-none shadow-lg bg-white dark:bg-slate-800">
                    <CardHeader>
                        <CardTitle className="text-xl text-slate-900 dark:text-white flex items-center gap-2">
                             <Building className="h-5 w-5 text-primary-500" /> Informations de l'Entreprise
                        </CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-6">
                        <div className="grid md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <label className="text-sm font-semibold text-slate-700 dark:text-slate-300">Nom de l'Entreprise</label>
                                <Input
                                    value={formData.name}
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-semibold text-slate-700 dark:text-slate-300">Secteur d'activité</label>
                                <Input
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-semibold text-slate-700 dark:text-slate-300">Site Web</label>
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-semibold text-slate-700 dark:text-slate-300">Année de Fondation</label>
                                <div className="relative">
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-semibold text-slate-700 dark:text-slate-300">Siège Social / Localisation</label>
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-semibold text-slate-700 dark:text-slate-300">Email de Contact (Public)</label>
                                <div className="relative group">
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-semibold text-slate-700 dark:text-slate-300">Téléphone de Contact</label>
                                <div className="relative">
                        ...
                        <div className="pt-4 space-y-4">
                            <h3 className="text-sm font-bold text-slate-900 dark:text-white uppercase tracking-wider flex items-center gap-2">
                                <MapPin className="h-4 w-4 text-red-500" /> Géolocalisation sur la carte
                            </h3>
                            ...
                            {formData.latitude && formData.longitude ? (
                                ...
                                <div className="mt-4 rounded-xl border-2 border-dashed border-slate-200 dark:border-slate-700 h-64 w-full bg-slate-50 dark:bg-slate-900/50 flex flex-col items-center justify-center text-slate-400 dark:text-slate-500">
                                    ...
                                    <p className="text-sm font-medium">Entrez la latitude et longitude pour activer la carte</p>
                        ...
                        <div className="space-y-2">
                            <label className="text-sm font-semibold text-slate-700 dark:text-slate-300">Description de l'Entreprise</label>
                            <textarea
                                ...
                                placeholder="Présentez votre entreprise aux étudiants et diplômés..."
                            />
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card className="border-none shadow-lg bg-white dark:bg-slate-800">
                    <CardHeader>
                        <CardTitle className="text-xl text-slate-900 dark:text-white flex items-center gap-2">
                            <Linkedin className="h-5 w-5 text-[#0077b5]" /> Réseaux Sociaux
                        </CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-6">
                        <div className="grid md:grid-cols-2 gap-6">
                ...
                <Card className="border-none shadow-lg bg-white dark:bg-slate-800">
                    <CardHeader>
                        <CardTitle className="text-xl text-slate-900 dark:text-white flex items-center gap-2">
                            <ImageIcon className="h-5 w-5 text-purple-500" /> Galerie Photos
                        </CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                            ...
                            <label className="aspect-video border-2 border-dashed border-slate-200 dark:border-slate-700 rounded-xl flex flex-col items-center justify-center cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-900 transition-all group">
                                ...
                                <span className="mt-2 text-xs font-medium text-slate-500 uppercase tracking-wider">Ajouter une photo</span>
            ...
            <div className="pt-12 border-t border-slate-200 dark:border-slate-800">
                <div className="flex items-center justify-between mb-8">
                    <h2 className="text-xl font-bold text-slate-900 dark:text-white flex items-center gap-2">
                        <Send className="h-5 w-5 text-primary-500" /> Aperçu du Footer Public
                    </h2>
                    <Button 
                        variant="outline" 
                    ...
                    >
                        <ExternalLink className="h-4 w-4" /> Voir Profil Public
                    </Button>
                </div>
